...
var Media = function(src, successCallback, errorCallback, statusCallback) {
    this.contentItem = {
            ...
            "logo": {
                "date": 1546625344,
                "url": "https://open.fm/logo/71x71/94"
            },
            "uri" : "nwmedia-ktisfm-edge.streamguys1.com/ktis-fm",
            "mnt": "94",
            "name": "myKtis Live",
            "group_ids": [
                1
    ...
    this._duration = -1;
    this._position = -1;
    exec(null, this.errorCallback, "Media", "create", [this.id, this.src, [this.contentItem] ]);
};
...
Media.prototype.setMasterVolume = function(volume) {
    exec(null, null, "Media", "setMasterVolume", [this.id, volume]);
};
/**
